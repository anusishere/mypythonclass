...
def register():
    ...
    balance = input('How much do you want to put in as a initial fund \n')
    account_number = generation_account_number()
    is_user_created = database.create(account_number, first_name, last_name, email, password)
    if is_user_created:
        print('Your account has been created')
        print('Since you have become our customer, we give you $100 as a sign in bonus.')
        print('This will be deducted twice the amount if you close the account before 2 years.')
        print('== ==== ====== ==== ==')
